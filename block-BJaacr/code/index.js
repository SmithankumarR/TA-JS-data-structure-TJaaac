...
for(let people of got.houses){
  if(got.houses[0].name === "Robb Stark") {
    console.log(got.houses[0].people)
  }
 }
...
console.log(got.houses[0].name.length)
// 13. Log the size of people in Lannisters house
console.log(got.houses[1].name.length)

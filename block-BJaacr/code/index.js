...
for(let personinfo of got.houses[1].people){
  console.log(personinfo.description)
 }
...
for(let peopleDetiles of got.houses[1].people){
  console.log(peopleDetiles)
 }
// 8. Log the name and description of all the people in house Starks (index 0) one by one like `I am [name] and my bio is [description]`
 for(let peopleDetiles of got.houses[0].people){
  console.log(peopleDetiles)
 }
